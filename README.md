...
```
bash <(curl -Ls https://raw.githubusercontent.com/sinagrimm69/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/sinagrimm69/3x-ui/master/install.sh) v2.3.6
```
